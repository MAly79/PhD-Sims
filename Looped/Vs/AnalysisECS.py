...
# step et ke pe epair temp c_melTemp c_wallTemp v_Fcatom v_Pcomp2 press pxx pyy pzz pxy pxz pyz c_Vir c_Vir[1] c_Vir[2] c_Vir[3] c_Vir[4] c_Vir[5] c_Vir[6] c_melPress c_wallPress v_melDens v_surfcov v_aveRg v_Vwall v_srate v_D v_bwzmax zhi c_fbwall[1] c_fbwall[3] c_ftwall[1] c_ftwall[3] c_ggbot[1] c_ggbot[3] c_ggtop[1] c_ggtop[3]
    ...
    #---Density Profile---#
    zZDa,zZDt,zZDb0,zZVp,zZTp,zZPp,I,D = zZ_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS0\1_V',1)
    zZDa,zZDt,zZDb1,zZVp,zZTp,zZPp,I,D = zZ_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS1\1_V',1)
    zZDa,zZDt,zZDb2,zZVp,zZTp,zZPp,I,D = zZ_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS2\1_V',1)
    zZDa,zZDt,zZDb3,zZVp,zZTp,zZPp,I,D = zZ_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS3\1_V',1)

    plt.rcParams.update({'font.size': 15})
    fig, ax = plt.subplots(figsize=(10,8))
    l0, = ax.plot(zZDb0[0] , zZDb0[1], 'r--')
    l1, = ax.plot(zZDb1[0] , zZDb1[1], 'g--')
    l2, = ax.plot(zZDb2[0] , zZDb2[1], 'b--')
    l3, = ax.plot(zZDb3[0] , zZDb3[1], 'b-')
    plt.legend([l0,l1,l2,l3], [r'$L=0$',r'$L=10$',r'$L=20$',r'$L=30$'], loc=1)
    ax.set(xlim=[0,D/3],xlabel='$z$', ylabel= r'$\phi(z)$' , title='')
    ax.minorticks_on()
    plt.savefig('1-EquilDP-M-60.jpg')   
#     
#     #---Brush Height---#
#     
...
#     plt.savefig('2-CompCurve.jpg')
    ...
    zDDa,zDDt,zDDb,zDVp,zDTp,zDPp = zD_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS0\1_V',2)
    zDDa3,zDDt3,zDDb3,zDVp,zDTp,zDPp = zD_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS3\1_V',2)


    fig, ax = plt.subplots(figsize=(10,8))
    lb0, = ax.plot(zDDb[0] , zDDb[1], 'r--')
    lt0, = ax.plot(zDDt[0] , zDDt[1], 'b--')
    la0, = ax.plot(zDDa[0] , zDDa[1], 'g--')
    lb3, = ax.plot(zDDb3[0] , zDDb3[1], 'r-')
    lt3, = ax.plot(zDDt3[0] , zDDt3[1], 'b-')
    la3, = ax.plot(zDDa3[0] , zDDa3[1], 'g-')
    
    plt.legend([la0,la3], [r'$L=0$',r'$L=30$'], loc=9)
    ax.set(xlim=[0,1],xlabel='$z/D$', ylabel= r'$\phi(z)$' , title='')
    ax.minorticks_on()
    plt.savefig('2-InterpenetrationC.jpg')
#     
    zDDa,zDDt,zDDb,zDVp,zDTp,zDPp = zD_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS0\1_V',3)
    zDDa3,zDDt3,zDDb3,zDVp,zDTp,zDPp = zD_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS3\1_V',3)
    ...
    ax.set(xlim=[0,1],xlabel='$z/D$', ylabel= r'$\phi(z)$' , title='')
    ax.minorticks_on()
    plt.savefig('2-InterpenetrationS.jpg')
#     
    ...
    zDDa,zDDt,zDDb,zDVp,zDTp,zDPp = zD_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS0\1_V',3)
    zDDa3,zDDt3,zDDb3,zDVp3,zDTp3,zDPp3 = zD_profs(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS3\1_V',3)    
    fig, ax1 = plt.subplots(figsize=(10,8))
    ax2 = ax1.twinx()   
    T1, = ax1.plot(zDTp[0],zDTp[1], 'r--')
    D1, = ax1.plot(zDDa[0],zDDa[1], 'g--')
    V1, = ax2.plot(zDVp[0],zDVp[1], 'b--')
    T3, = ax1.plot(zDTp3[0],zDTp3[1], 'r-')
    D3, = ax1.plot(zDDa3[0],zDDa3[1], 'g-')
    V3, = ax2.plot(zDVp3[0],zDVp3[1], 'b-')
        
    plt.legend([T3,V3,D3], [r'Temperature','Velocity','Density'], loc=9)
    ax1.set(xlim=[0,1],ylim=[0,1.5],xlabel='$z/D$', ylabel= r'$T, \phi(z)$')
    ax2.set(ylim=[-0.15,0.15], ylabel= r'V')
    ax1.minorticks_on()
    ax2.minorticks_on()
    ...
    Pzx3, = ax1.plot(zDPp3[0],zDPp3[1][:,0], 'r-')
    Pzz3, = ax1.plot(zDPp3[0],zDPp3[1][:,2], 'b-')
    D3, = ax2.plot(zDDa3[0],zDDa3[1], 'g-')
    plt.legend([Pzx3,Pzz3,D3], [r'$P_{zx}$',r'$P_{zz}$',r'$\phi(z)$'], loc=9)
    ax1.set(xlim=[0,1],ylim=[0,5],xlabel='$z/D$', ylabel= r'$P_{zz,zx}$')
...
#     
    ...
    Vs0,Cs0 = read_thermo(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS0',[13,15,30],3)    
    Vs1,Cs1 = read_thermo(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS1',[13,15,30],3)    
    Vs2,Cs2 = read_thermo(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS2',[13,15,30],3)    
    Vs3,Cs3 = read_thermo(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Looped\N-30\LPBB-ECS3',[13,15,30],3)    
    ...
    fig, ax1 = plt.subplots(figsize=(10,8))
    l0, = ax1.plot(Cs0[:,2],mu0, 'ro')
    l1, = ax1.plot(Cs1[:,2],mu1, 'go')
    l2, = ax1.plot(Cs2[:,2],mu2, 'bo')
    l3, = ax1.plot(Cs3[:,2],mu3, 'ko')

    
    plt.legend([l0,l1,l2,l3], [r'$L=0$',r'$L=10$',r'$L=20$',r'$L=30$'], loc=9)
    ax1.set(xlabel=r'$\.\gamma$', ylabel= r'$\mu$', xlim=[0,0.12], ylim=[0,0.45])
    ax1.minorticks_on()
