...
#     
    ...
    D1,T1,V1 = read_tvdp(r'C:\Users\klay_\OneDrive - Imperial College London\PhD\PhD-Sims\Slower\Vscale-dt-0.0005\Long\MDPBB-ECS0\1_V')
    ...
    ax1.minorticks_on()
    ax2.minorticks_on()
    plt.savefig('0l-TnVprofiles.jpg')    
    ocwd = os.getcwd()
    print(ocwd)
#     #--- Convergence check T---#
#     
